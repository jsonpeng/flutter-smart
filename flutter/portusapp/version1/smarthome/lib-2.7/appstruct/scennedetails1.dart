...
class SceneDetailsPage extends StatefulWidget {
  SceneDetailsPage({Key key,}): super(key: key) {}
  @override
  _SceneDetailsPageState createState() => new _SceneDetailsPageState();
}


class _SceneDetailsPageState extends State<SceneDetailsPage>{
